...
<html lang="en">
    ...
    <body>
        <div class="mashmenu">
            <div id="menuWrapper">   
            <?
                if (($_SESSION["account_type"])=="member") { # if account type is member, execute this navigation bar
                echo '
                ...
                elseif (($_SESSION["account_type"])=="staff") { # if account type is staff, execute this navigation bar
                echo '
                    <div class="fnav">
                        <a href="../MainSite/homepage.php" class="flink" >Home</a>
                        <a href="../MainSite/about.php" class="flink" >About</a>
                ...
                elseif (($_SESSION["account_type"])=="admin") { # if account type is admin, execute this navigation bar
                     echo '
