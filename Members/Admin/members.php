...
if(isset($_POST['searchButton'])){
	...
	echo '<tr class="header"><th>First Name</th><th>Last Name</th><th>DOB</th><th>Contact Number</th><th>Email Address</th><th>Height</th><th>Weight</th><th>Account Type</th></tr>';
	while($row1 = mysqli_fetch_array($searchResults)){
		...
		echo '<td><a href="editmembers.php?userid=' . mysql_result($result, $i, 'userid') . '">Edit</a></td>';
		echo '<td><a href="deletemembers.php?userid=' . mysql_result($result, $i, 'userid') . '">Delete</a></td>';
...
<body>
	...
	for ($i = $start; $i < $end; $i++)
	{
		...
		echo '<td><a href="editmembers.php?userid=' . mysql_result($result, $i, 'userid') . '">Edit</a></td>';
		echo '<td><a href="deletemembers.php?userid=' . mysql_result($result, $i, 'userid') . '" onclick="return makesure();">Delete</a></td>';
		echo "</tr>"; 
	}
	// close table>
	echo "</table>"; 
