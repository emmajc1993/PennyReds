...
<body>
        <div class="mashmenu">
            ...
            <div class="fnav">
                ...
                <a href="../Contact/contact.php" class="flink" >Contact </a>
            ...
            else 
            {
                ...
                <div class="fnav">
                <a href="homepage.php" class="flink" >Home</a>
                <a href="about.php" class="flink" >About</a>
                <a href="../PhotoGallery/index.php" class="flink" >Gallery</a>
                <a href="events.php" class="flink" >Upcoming Events</a>
                <a href="prices.php" class="flink" >Prices</a>
